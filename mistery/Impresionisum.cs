...
namespace mistery
{
    public partial class Impresionisum : Form
    {
        ...
        {
            ImpresInfo imp = new ImpresInfo();
            imp.Show();
            this.Hide();
        }

        private void Impresionisum_Load(object sender, EventArgs e)
        {
        ...
        private void Impresionisum_Resize(object sender, EventArgs e)
        {
