...
namespace mistery
{
    public partial class Barock : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (code == "Медуза")
            {
                BaroqueInfo bif = new BaroqueInfo();
                bif.Show();
                this.Hide();
            }
            else
        ...
        private void Barock_Load(object sender, EventArgs e)
        {
        ...
        private void Barock_Resize(object sender, EventArgs e)
        {
